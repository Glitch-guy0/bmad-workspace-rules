# NFR, Tech Debt & File Indexing

Non-functional requirements management, tech debt tracking, and the four-layer file indexing system.
...
| | NFR | Tech Debt |
|---|---|---|
| What | System property that does not exist yet | Something that exists but is suboptimal |
